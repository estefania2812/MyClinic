...
public class IllnessesListViewDemoAdapter extends ArrayAdapter<Illness> {
	
	//====================================================================================

    public IllnessesListViewDemoAdapter(Context context, List<Illness> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       Illness item = getItem(position);
        ...
        viewHolder.ivIcon.setBackgroundResource(R.drawable.icon_ill);       
        return convertView;
    }
	//====================================================================================
